...
const Icon = ({ name, className }: { name: string, className?: string }) => {
  const icons: { [key: string]: React.ReactNode } = {
    'sunday': <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className={cn("h-6 w-6", className)}><path d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256 256-114.6 256-256S397.4 0 256 0zM352.5 288.1c-11.3 11.3-27 11.3-38.3 0l-56.2-56.2-56.2 56.2c-11.3 11.3-27 11.3-38.3 0-11.3-11.3-11.3-27 0-38.3l56.2-56.2-56.2-56.2c-11.3-11.3-11.3-27 0-38.3 11.3-11.3 27-11.3 38.3 0l56.2 56.2 56.2-56.2c11.3-11.3 27-11.3 38.3 0 11.3 11.3 11.3 27 0 38.3l-56.2 56.2 56.2 56.2c11.3 11.3 11.3 27 0 38.3z"/></svg>,
    'monday': <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" fill="currentColor" className={cn("h-6 w-6", className)}><path d="M16 64C16 28.7 44.7 0 80 0H208c35.3 0 64 28.7 64 64V256h48c26.5 0 48 21.5 48 48s-21.5 48-48 48H272V448c0 35.3-28.7 64-64 64H80c-35.3 0-64-28.7-64-64V352H64c26.5 0 48-21.5 48-48s-21.5-48-48-48H16V64zM208 256V64H80v32h80c26.5 0 48 21.5 48 48s-21.5 48-48 48H80v32h80c26.5 0 48 21.5 48 48s-21.5 48-48 48H80v96h64c8.8 0 16-7.2 16-16V352h48c8.8 0 16-7.2 16-16s-7.2-16-16-16H224V272h48c8.8 0 16-7.2 16-16s-7.2-16-16-16H208z"/></svg>,
