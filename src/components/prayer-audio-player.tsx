  ...
  return (
    <div className="w-full">
      <Button 
        ...
        className={cn(
            "w-full sm:w-auto",
            theme === 'theme-light-gray' ? 'text-primary border-primary/50 hover:bg-primary/10 hover:text-primary' : 'text-white border-white/50 hover:bg-white/10 hover:text-white'
        )}
      >
